...
namespace WMS.UI
{
    class StockInfoCheckTickettModifyViewMetaData1
    {
        private static KeyName[] keyNames = {
            ...
            new KeyName(){Key="ExcpetedOverflowAreaAmount",Name="溢库区数量",Visible=true ,Editable=true ,Save=true },
            new KeyName(){Key="ExpectedShipmentAreaAmount",Name="发货区数量",Visible=true ,Editable=true ,Save=true },
            new KeyName(){Key="RealOverflowAreaAmount",Name="实际溢库区数量",Visible=true ,Editable=true ,Save=true },
           new KeyName(){Key="RealShipmentAreaAmount",Name="实际发货区数量",Visible=true ,Editable=true ,Save=true },
