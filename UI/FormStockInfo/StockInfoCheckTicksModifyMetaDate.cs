...
namespace WMS.UI
{
    class StockInfoCheckTicksModifyMetaDate
    {
        private static KeyName[] keyNames = {
            ...
            new KeyName(){Key="OverflowAreaAmount",Name="溢库区数量",Editable=false ,Save=true},
            new KeyName(){Key="ShipmentAreaAmount",Name="发货区数量",Editable=false ,Save=true},
            ...
            //,
            new KeyName(){Key="RealOverflowAreaAmount",Name="实际溢库区数量",Editable=true ,Save=false}
            ,
            new KeyName(){Key="RealShipmentAreaAmount",Name="实际发货区数量",Editable=true ,Save=false}
            ,
