...
namespace WMS.UI
{
    class StockInfoCheckTicketViewMetaData
    {
        private static KeyName[] keyNames = {
            ...
            new KeyName(){Key="ProjectID",Name="项目ID",Visible=true ,Editable=true},
            new KeyName(){Key="WarehouseID",Name="仓库ID",Visible=true,Editable=true,Save=false},
            new KeyName(){Key="CheckDate",Name="盘点日期",Visible=true,Editable=true,Save=false},
            new KeyName(){Key="CreateUserID",Name="创建用户ID",Visible=true,Editable=true,Save=false},
            new KeyName(){Key="CreateTime",Name="创建时间",Visible=true,Editable=true,Save=false},
            new KeyName(){Key="LastUpdateUserID",Name="最后更新用户ID",Visible=true,Editable=true,Save=false},
