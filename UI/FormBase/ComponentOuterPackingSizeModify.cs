...
namespace WMS.UI
{
    public partial class ComponentOuterPackingSizeModify : Form
    {
        ...
        const int SUPPLY_OuterPackingSize = 0;
        const int COMPONENT_OuterPackingSize = 1;
        private WMSEntities wmsEntities = new WMSEntities();
        private Action<int> modifyFinishedCallback = null;
        private Action<int> addFinishedCallback = null;
        private FormMode mode = FormMode.ALTER;

        public ComponentOuterPackingSizeModify(int userID, int setItem, int ID = -1)
        {
            InitializeComponent();
        ...
        public void SetMode(FormMode mode)
        {
            ...
            {
                this.Text = "零件外包装信息";
                this.groupBox1.Text = "零件外包装信息";
                this.buttonOK.Text = "零件外包装信息";
            }
