...
namespace WMS.UI
{
    class ShipmentTicketItemViewMetaData
    {
        ...
        private static KeyName[] keyNames = {
            ...
            new KeyName(){Key="ComponentName",Name="零件",Editable=true,Save=false},
            ...
            new KeyName(){Key="ReturnAmount",Name="退回数量",Editable=true},
            new KeyName(){Key="ReturnReason",Name="退回原因",Editable=true},
