...
namespace WMS.UI.FormReceipt
{
    ...
    public class ReceiptMetaData
    {
        public static KeyName[] receiptNameKeys =
        {
            ...
            new KeyName(){Name = "负责人", Key = "PersonName", Visible = true, Editable = true, Save = false},
            new KeyName(){Name = "是否过账", Key = "HasPosted", Visible = true, Editable = true, ComboBoxItems = new ComboBoxItem[]{new ComboBoxItem("是", "是"), new ComboBoxItem("否", "否") } },
        ...
        public static KeyName[] submissionTicketKeyName =
        {
            ...
            new KeyName(){Name="送检员", Key="DeliverSubmissionPersonName",Visible=true,Editable=true,Save=false},
            new KeyName(){Name="质检接收员ID", Key="ReceivePersonID",Visible=false,Editable=false},
            new KeyName(){Name="质检接收员", Key="ReceivePersonName",Visible=true,Editable=true, Save = false},
            new KeyName(){Name="质检员ID", Key="SubmissionPersonID",Visible=false,Editable=false},
            new KeyName(){Name="质检员", Key="SubmissionPersonName",Visible=true,Editable=true, Save = false},
        ...
        public static KeyName[] itemsKeyName =
        {
            ...
            new KeyName(){Name="零件编号", Key="SupplyNo", Visible = true, Editable = false, Save = false, EditPlaceHolder = "点击选择零件"},
            new KeyName(){Name="零件名称", Key="ComponentName", Visible=true, Editable = false, Save = false, EditPlaceHolder = "自动生成"},
            ...
            new KeyName(){Name="收货数量", Key="UnitCount", Visible=true,Editable=true,Save=true},
