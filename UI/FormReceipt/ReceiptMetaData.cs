...
namespace WMS.UI.FormReceipt
{
    ...
    public class ReceiptMetaData
    {
        public static KeyName[] receiptNameKeys =
        {
            ...
            new KeyName(){Name = "负责人", Key = "PersonName", Visible = true, Editable = true, Save = false, EditPlaceHolder = "点击可选择"},
        ...
        public static KeyName[] submissionTicketKeyName =
        {
            ...
            new KeyName(){Name="送检单单号", Key="No",Visible=true,Editable=false, EditPlaceHolder = "自动生成"},
            ...
            new KeyName(){Name="送检员", Key="DeliverSubmissionPersonName",Visible=true,Editable=true,Save=false, EditPlaceHolder = "点击可选择"},
            new KeyName(){Name="质检接收员ID", Key="ReceivePersonID",Visible=false,Editable=false},
            new KeyName(){Name="质检接收员", Key="ReceivePersonName",Visible=true,Editable=true, Save = false,EditPlaceHolder = "点击可选择"},
            new KeyName(){Name="质检员ID", Key="SubmissionPersonID",Visible=false,Editable=false},
            new KeyName(){Name="质检员", Key="SubmissionPersonName",Visible=true,Editable=true, Save = false, EditPlaceHolder = "点击可选择"},
        ...
        public static KeyName[] itemsKeyName =
        {
            ...
            new KeyName(){Name="单位数量", Key="UnitAmount",Visible=true,Editable=true,Save=true, NotNegative = true},
            ...
            new KeyName(){Name="期待数量", Key="ExpectedAmount",Visible=true,Editable=true,Save=true, NotNegative = true},
            //new KeyName(){Name="收货数量", Key="ReceiviptAmount",Visible=true,Editable=true,Save=true},
        ...
        public static KeyName[] submissionTicketItemKeyName =
        {
            ...
            new KeyName(){Name="状态", Key="State",Visible=true,Editable=true,Save=true, ComboBoxItems = new ComboBoxItem[] { new ComboBoxItem("合格", "合格"), new ComboBoxItem("不合格", "不合格"), new ComboBoxItem("待检", "待检")} },
            ...
            new KeyName(){Name="不合格数量", Key="RejectAmount",Visible=true,Editable=true, Save =true},
        ...
        {
            new KeyName{Name = "ID", Key = "ID", Visible = false, Editable = false, Save = true},
            new KeyName{Name = "上架单编号", Key = "No", Visible = true, Editable = false, Save = true, EditPlaceHolder= "留空自动生成"},
